...
class ActorModel(nn.Module):#actor net
    def __init__(self, obsinput_size, output_size):
        super(ActorModel, self).__init__()
        hid_size1 = 64
        hid_size2 = 128
        self.fc_layer1 = nn.Linear(obsinput_size, hid_size1)#Fully connected layer
...
class CriticModel(nn.Module):#Q net
    def __init__(self, input_size,output_size):
        super().__init__()
        hid_size1 = 64
        hid_size2 = 128
        self.fc_layer1 = nn.Linear(input_size, hid_size1)#Fully connected layer
        self.fc_layer2 = nn.Linear(hid_size1, hid_size2)
        self.fc_layer3 = nn.Linear(hid_size2, output_size)
